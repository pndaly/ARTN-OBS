...
def test_flats_2():
    ...
    assert isinstance(Flats(_tel, _ins), observations.flats.Flats)
...
def test_flats_3():
    ...
    _tel = INS__TELESCOPE[_ins]
    # noinspection PyUnresolvedReferences
    assert isinstance(Flats(_tel, _ins).telescope, telescopes.factory.Telescope)
...
def test_flats_4():
    ...
    _tel = INS__TELESCOPE[_ins]
    # noinspection PyUnresolvedReferences
    assert isinstance(Flats(_tel, _ins).instrument, instruments.factory.Instrument)
