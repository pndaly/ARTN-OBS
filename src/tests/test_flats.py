...
# -
def test_flats_1():
    """ test Flats() for incorrect input(s) """
    with ptr(Exception):
        Flats(telescope=random.choice([None, get_hash(), {}, [], ()]))


def test_flats_2():
    """ test Flats() for incorrect input(s) """
    with ptr(Exception):
        Flats(instrument=random.choice([None, get_hash(), {}, [], ()]))


# noinspection PyUnresolvedReferences
def test_flats_3():
    """ test Flats() for correct input(s) """
    _ins = random.choice(INS__INSTRUMENTS)
    _tel = INS__TELESCOPE[_ins]
    assert isinstance(Flats(_tel, _ins), observations.flats.Flats) in OBS_TRUE_VALUES
...
def test_flats_4():
    ...
    _ins = random.choice(INS__INSTRUMENTS)
    _tel = INS__TELESCOPE[_ins]
    assert isinstance(Flats(_tel, _ins).telescope, telescopes.factory.Telescope) in OBS_TRUE_VALUES
...
def test_flats_5():
    ...
    _ins = random.choice(INS__INSTRUMENTS)
    _tel = INS__TELESCOPE[_ins]
    assert isinstance(Flats(_tel, _ins).instrument, instruments.factory.Instrument) in OBS_TRUE_VALUES


def test_flats_6():
    """ test Flats() returns correct attribute(s) """
    _ins = random.choice(INS__INSTRUMENTS)
    _tel = INS__TELESCOPE[_ins]
    _d = Flats(_tel, _ins)
...
def test_flats_10():
    ...
    _ins = random.choice(INS__INSTRUMENTS)
    _tel = INS__TELESCOPE[_ins]
    _iso, _jd = Flats(_tel, _ins).calculate()
