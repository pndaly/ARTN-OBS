...
def test_non_sidereal_2():
    ...
    assert isinstance(NonSidereal(_tel, _ins), observations.non_sidereal.NonSidereal)
...
def test_non_sidereal_3():
    ...
    _tel = INS__TELESCOPE[_ins]
    # noinspection PyUnresolvedReferences
    assert isinstance(NonSidereal(_tel, _ins).telescope, telescopes.factory.Telescope)
...
def test_non_sidereal_4():
    ...
    _tel = INS__TELESCOPE[_ins]
    # noinspection PyUnresolvedReferences
    assert isinstance(NonSidereal(_tel, _ins).instrument, instruments.factory.Instrument)
